...
a==="string"),compare:(a,b)=>a<b?-1:+(a>b),decodeStringFromUTF8Array:()=>"",encodeStringToUTF8Array:()=>0,fromCharCodeArray:()=>"",length:a=>a.length,intoCharCodeArray:()=>0},e=Object.assign({Math:Z,bindings:G,js:Object.assign(ag,globalThis.__rocqz||{}),"wasm:js-string":u,"wasm:text-decoder":u,"wasm:text-encoder":u,str:new
...
c(a){var
c="Unknown error ";if(typeof
require==="undefined"){const
d=b[a];return d||c+a}const
d=require("node:util");if(a>=0){const
e=b[a];for(const
a
of
d.getSystemErrorMap())if(a[1][0]===e)return a[1][1];return e||c+a}else
return d.getSystemErrorMessage(a)}return{unix_error:b,caml_strerror:c}}(globalThis))({"link":[["code-3cd119fa9776d32c03e2",0]],"generated":(a=>{var
...
Error("rocq_is_accumulate_code not implemented")},"caml_unix_spawn":()=>{throw new
Error("caml_unix_spawn not implemented")},"caml_unix_socket":()=>{throw new
Error("caml_unix_socket not implemented")},"caml_unix_sigprocmask":()=>{throw new
Error("caml_unix_sigprocmask not implemented")},"caml_unix_kill":()=>{throw new
Error("caml_unix_kill not implemented")},"caml_unix_getservbyname":()=>{throw new
Error("caml_unix_getservbyname not implemented")},"caml_unix_getaddrinfo":()=>{throw new
Error("caml_unix_getaddrinfo not implemented")},"caml_unix_environment":()=>{throw new
Error("caml_unix_environment not implemented")},"caml_unix_dup":()=>{throw new
Error("caml_unix_dup not implemented")},"caml_unix_connect":()=>{throw new
Error("caml_unix_connect not implemented")}},"fragments":{"fun_call_1":(a,b)=>a(b),"get_AbortController":a=>a.AbortController,"get_Array":a=>a.Array,"get_ArrayBuffer":a=>a.ArrayBuffer,"get_Blob":a=>a.Blob,"get_DataView":a=>a.DataView,"get_Date":a=>a.Date,"get_Document":a=>a.Document,"get_Error":a=>a.Error,"get_EventSource":a=>a.EventSource,"get_FileReader":a=>a.FileReader,"get_Float32Array":a=>a.Float32Array,"get_Float64Array":a=>a.Float64Array,"get_FormData":a=>a.FormData,"get_HTMLElement":a=>a.HTMLElement,"get_Headers":a=>a.Headers,"get_Int16Array":a=>a.Int16Array,"get_Int32Array":a=>a.Int32Array,"get_Int8Array":a=>a.Int8Array,"get_IntersectionObserver":a=>a.IntersectionObserver,"get_Intl":a=>a.Intl,"get_JSON":a=>a.JSON,"get_Math":a=>a.Math,"get_MutationObserver":a=>a.MutationObserver,"get_Object":a=>a.Object,"get_PerformanceObserver":a=>a.PerformanceObserver,"get_Promise":a=>a.Promise,"get_RegExp":a=>a.RegExp,"get_Request":a=>a.Request,"get_ResizeObserver":a=>a.ResizeObserver,"get_Response":a=>a.Response,"get_SVGElement":a=>a.SVGElement,"get_String":a=>a.String,"get_Uint16Array":a=>a.Uint16Array,"get_Uint32Array":a=>a.Uint32Array,"get_Uint8Array":a=>a.Uint8Array,"get_WebSocket":a=>a.WebSocket,"get_Worker":a=>a.Worker,"get_document":a=>a.document,"get_fetch":a=>a.fetch,"get_geolocation":a=>a.geolocation,"get_hostname":a=>a.hostname,"get_href":a=>a.href,"get_length":a=>a.length,"get_location":a=>a.location,"get_navigator":a=>a.navigator,"get_pathname":a=>a.pathname,"get_performance":a=>a.performance,"get_port":a=>a.port,"get_protocol":a=>a.protocol,"get_search":a=>a.search,"get_unescape":a=>a.unescape,"js_expr_12c48ca8":()=>a,"js_expr_2319863a":()=>Error,"js_expr_28647a4c":()=>!1,"js_expr_34edcf72":()=>!0,"js_expr_8d6d831":()=>function(a){return Promise.resolve(a)},"js_expr_ba692c1":()=>undefined,"js_expr_ce95bdf":()=>function(a){return Promise.reject(a)},"meth_call_0_toString":a=>a.toString(),"meth_call_1_charAt":(a,b)=>a.charAt(b),"meth_call_1_indexOf":(a,b)=>a.indexOf(b),"meth_call_1_slice":(a,b)=>a.slice(b),"meth_call_1_split":(a,b)=>a.split(b),"meth_call_2_replace":(a,b,c)=>a.replace(b,c),"meth_call_2_slice":(a,b,c)=>a.slice(b,c),"new_1":(a,b)=>new
a(b),"new_2":(a,b,c)=>new
a(b,c),"obj_0":(a,b,c,d,e,f,g,h)=>({alpha:a,depth:b,stencil:c,antialias:d,premultipliedAlpha:e,preserveDrawingBuffer:f,preferLowPowerToHighPerformance:g,failIfMajorPerformanceCaveat:h}),"obj_1":(a,b,c,d,e,f,g,h,i,j,k,l)=>({href:a,protocol:b,host:c,hostname:d,port:e,pathname:f,search:g,hash:h,origin:i,reload:j,replace:k,assign:l}),"obj_2":(a,b,c,d,e)=>({ready:a,version:b,mount:c,read_file:d,check:e}),"set_RocqComparator":(a,b)=>a.RocqComparator=b,"set_lastIndex":(a,b)=>a.lastIndex=b}}})(globalThis),"src":"engine-jspi/rocq_engine.assets"});
